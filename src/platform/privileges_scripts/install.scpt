on run {daemon_file, agent_file, user}
  ...
  set sh1 to "echo " & quoted form of daemon_file & " > /Library/LaunchDaemons/com.carriez.PN-Fernwartung_service.plist && chown root:wheel /Library/LaunchDaemons/com.carriez.PN-Fernwartung_service.plist;"
  ...
  set sh5 to "launchctl bootout system/com.carriez.PN-Fernwartung_service 2>/dev/null || launchctl unload -w /Library/LaunchDaemons/com.carriez.PN-Fernwartung_service.plist 2>/dev/null || true; launchctl bootstrap system /Library/LaunchDaemons/com.carriez.PN-Fernwartung_service.plist 2>/dev/null || launchctl load -w /Library/LaunchDaemons/com.carriez.PN-Fernwartung_service.plist;"
